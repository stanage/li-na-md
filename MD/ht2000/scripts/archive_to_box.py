...
Why this exists. prod.xtc is ~95% of the campaign's footprint: 115 GB of the
132 GB total, against roughly 40 GB of headroom in the pi-chibueze /project
quota. Runs therefore live on scratch (2 TB limit) and their trajectories are
pushed to Box, which is effectively unlimited.
