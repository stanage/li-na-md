"""Shared helpers for the 2000-electrolyte high-throughput MD campaign.
...
# ---------------------------------------------------------------- paths
HT = Path(__file__).resolve().parent.parent          # MD/ht2000
MD = HT.parent                                        # MD
...
DATASET = REPO / "datasets" / "electrolyte_dataset_2000.csv"
